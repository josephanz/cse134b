...
var fields = {
  ...
  visited: String(Parse.User.current())
};
...
function saveIt() {
  ...
  if (title == "" || title == null) {
    ...
    addHabit(title, perWeek, Number(perDay), time, parseImg);
  }
}
...
function addHabit(title, perWeek, perDay, notificationTime, parseImg) {
  ...
  testObject.save(null, {
    success: function(object) {
      $(".success").show();
			var fields = {
        user: String(Parse.User.current())
      }
      Parse.Analytics.track('AddHabitSuccess', fields);
